...
namespace Game.Editor
{
    ...
    public static class InkspellValidation
    {
        ...
        public static void CompileMiniGameScripts()
        {
            ...
            {
                var directory = Path.GetFullPath("Logs/InkspellValidation/" + platform);
                ...
                Debug.Log($"[InkspellValidation] {platform} Player 脚本编译通过，共 {result.assemblies.Count} 个程序集。");
            }
        }
    }
}
